...
?>
    <form method="POST" action="index.php?page=setting-save&id=<?php echo $row['id']; ?>" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control"  name="sitetitle" id="sitetitle" value="<?php echo $row['sitetitle']; ?>">
        </div>
        <div class="form-group">
            <label>توضیحات سایت</label>
            <input type="text" class="form-control"  name="sitedescription" id="sitedescription" value="<?php echo $row['sitedescription']; ?>">
        </div>
        <div class="form-group">
            <label>متن کپی رایت</label>
            <input type="text" class="form-control"  name="sitecopyright" id="sitecopyright" value="<?php echo $row['sitecopy']; ?>">
        </div>
        <div class="form-group">
            <label>لوگوی سایت</label>
            <input type="file" class="form-control"  name="sitelogo" id="sitelogo" value="<?php echo $row['sitelogo']; ?>">
            <img src="uploads/site/<?php echo $row['sitelogo']; ?>"  width="100" height="100">
        </div>
        <div class="form-group">
            <label>آیکون سایت</label>
            <input type="file" class="form-control"  name="siteicon" id="siteicon" value="<?php echo $row['siteicon']; ?>">
            <img src="uploads/site/<?php echo $row['siteicon']; ?>" width="40" height="40">
        </div>
        <label>اسکریپت هدر</label>
        <div class="form-group">
            <textarea  cols="100" rows="10" name="headerscript" id="headerscript"><?php echo $row['headerscript']; ?></textarea>
        </div>
    ...
    <form method="POST" action="index.php?page=setting-save&id=<?php echo $roab['id']; ?>" enctype="multipart/form-data">
        ...
        <?php echo $roab['description']; ?>
            ...
            <div class="form-group">
                ...
                <input type="file" class="form-control" name="aimg" id="aimg">
                <img src="uploads/site/<?php echo $roab['image']; ?>" alt="" width="300" height="300">
            </div>
            <div class="form-group">
