...
<section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="active">
                        <a href="http://localhost/golshani/adminpanel"><i class="fa fa-dashboard"></i> <span>میزکار</span></a>
                        </li>      
                        <li class="treeview">
                        <a href="#">
                            <i class="fa fa-th"></i>
              ...
              <span class="label  pull-left bg-green ">4</span>
                        ...
                        <ul class="treeview-menu">
                            <li><a href="index.php?page=articles&action=new"><i class="fa fa-circle-o"></i>برگه جدید</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
              ...
              <span class="label  pull-left bg-green ">4</span>
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="index.php?page=articles&action=list"><i class="fa fa-circle-o"></i>دسته بندی مقالات </a></li>
              ...
              <span class="label  pull-left bg-yellow">4</span>
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="index.php?page=services&action=other"><i class="fa fa-circle-o"></i>دسته بندی اخبار </a></li>
                       </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
              ...
              <span class="label  pull-left bg-green ">4</span>
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="index.php?page=product&action=list"><i class="fa fa-circle-o"></i>دسته بندی محصولات</a></li>
